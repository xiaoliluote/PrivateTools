...
public class CountDownView extends View{
    ...
    public CountDownView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRingColor = a.getColor(R.styleable.CountDownView_ringColor, Color.parseColor("#ffffff"));
        mRingWidth = a.getFloat(R.styleable.CountDownView_ringWidth, getResources().getDimensionPixelSize(R.dimen.px14));
        mRingProgessTextSize = a.getDimensionPixelSize(R.styleable.CountDownView_progressTextSize, getResources().getDimensionPixelSize(R.dimen.px40));
        mProgessTextColor = a.getColor(R.styleable.CountDownView_progressTextColor, Color.parseColor("#ffffff"));
    ...
    public void setProgressTextColor(int color){
        this.mProgessTextColor = color;
    }

    /**
     * 倒计时字体大小
     * @param size  默认在1920*1080尺寸下的40px
     */
    public void setProgressTextSize(int size){
        this.mRingProgessTextSize = getResources().getDimensionPixelSize(size);
    }
